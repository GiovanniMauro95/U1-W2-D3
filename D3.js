...
let crewMass = 0
let y = 0
while (y <= starWarsCharacters.length - 1) {
  crewMass = starWarsCharacters[y].mass + crewMass
  y += 1
}
...
for (i = 0; i < starWarsCharacters.length; i++) {
  totalMass = starWarsCharacters[i].mass + totalMass
}
if (totalMass < 500) {
...
for (i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    ...
    console.log("Added Robot", starWarsCharacters[i])
  }
}
...
for (i = 0; i < charactersNames.length; i++) {
  for (z = 0; z < femaleCharacters.length; z++) {
    if (femaleCharacters[z].name === charactersNames[i]) {
